...
impl DocType {
    pub fn get_doc(self) -> &'static str {
        match self {
            ...
            DocType::NO_RETURN => {
                "\n/** Sahitron4000 tries to identify return statement and replace with rust equivalent\n \
                 * shorthand notation. If error found in this line, Please replace shorthand \
                 notation \n * with return statement \n **/\n"
            }
            DocType::INCLUDE_STMT => {
                "\n/** Sahitron4000 doesn't resolve C/C++ dependencies or included header.\n* You may have \
                 to define your own module and implement those functionality in Rust \n* Or you \
                 can translate header file with Sahitron4000 to produce Rust code. * \n* >>>>>>>>"
            }
            DocType::NO_POINTER => {
                "\n/** Sahitron4000 doesn't support pointers yet,\
            ...
            DocType::CRUST => {
                "/*************************************************************************\
                \n * This file was generated by Sahitron4000 by an automated semantics preserving\
                \n * translation from C/C++ to Rust\
                \n * Sahitron4000 isn't perfect and may require manual editing\
                \n * Check warnings and errors and refer to the official Rust Documentation\
                \n ************************************************************************/\n"
            }
            DocType::UNION => {
                "\n/* Sahitron4000 does not hanlde C/C++ tagged union type completely.\
            ...
            DocType::OPERATOR_OVERLOAD => {
                "\n/* Operator overloading is not supported at the current state of Sahitron4000.\
